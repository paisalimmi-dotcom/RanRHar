...
Staff portal — ลิงก์สำหรับเจ้าหน้าที่เข้าสู่ระบบ, KDS, ออเดอร์, สต็อก, สรุปโต๊ะ
...
KDS (Kitchen Display) — หน้าจอสำหรับพ่อครัว แสดงออเดอร์ 3 คอลัมน์ (รอทำ/กำลังทำ/เสร็จแล้ว)

**Access**: Requires authentication (`owner`, `staff`)

**File**: `apps/web/src/app/staff/kds/page.tsx`

---

### GET /staff/tables

สรุปโต๊ะ — หน้าสำหรับพนักงานเสิร์ฟ แสดงออเดอร์รออาหารและเสร็จแล้ว

**Access**: Requires authentication (`owner`, `staff`, `cashier`)

**File**: `apps/web/src/app/staff/tables/page.tsx`
